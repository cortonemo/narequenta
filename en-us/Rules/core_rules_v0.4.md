## 📄 Nárëquenta Core Rules v0.4 (EN-US)
...
### 3. Acting in the World (Action Resolution & Attrition)
...
#### Actions Outside of Combat (v0.4 Update):
...
#### 4.3. Using Proficiency

**Using $\mathbf{D_{prof}}$:** The player rolls the $\mathbf{2\text{d}10}$ and **subtracts the result** from the target's Difficulty Class (DC) or Resistance roll in all contested checks using that Essence.
